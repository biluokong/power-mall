            ...
            <div class="state-cont">
              ...
              <div class="item-info">
                <el-form-item label="商品总价:">
                  <span class="text">￥{{dataForm.totalMoney}}</span>
                </el-form-item>
          ...
          <div class="order-log">
            ...
            <div class="log-cont">
              <el-form-item v-if="dataForm.createTime" label-width="10px">
                <span>{{dataForm.createTime}} {{dataForm.nickName}} 创建订单（成功）</span>
              </el-form-item>
    ...
    methods: {
      init (orderNumber) {
        ...
        if (this.dataForm.orderNumber) {
          // 修改
          this.$http({
            url: this.$http.adornUrl(`/order-service/order/order/orderInfo/${this.dataForm.orderNumber}`),
            method: 'get',
