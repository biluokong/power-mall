  ...
  methods: {
    init (areaId) {
      ...
      this.$nextTick(() => {
        ...
        if (this.dataForm.areaId) {
          this.$http({
            url: this.$http.adornUrl('/store-service/admin/area/info/' + this.dataForm.areaId),
            method: 'get',
        ...
        this.$http({
          url: this.$http.adornUrl('/store-service/admin/area/list'),
          method: 'get',
          params: this.$http.adornParams()
        }).then(({ data }) => {
    ...
    dataFormSubmit () {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          this.$http({
            url: this.$http.adornUrl('/store-service/admin/area'),
